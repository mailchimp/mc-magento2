...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (version_compare($context->getVersion(),'1.1.33') < 0) {
            $connection->addIndex(
                $setup->getTable('mailchimp_sync_ecommerce'),
        ...
        if (version_compare($context->getVersion(), '100.1.43') < 0) {
            $connection->addIndex(
                $setup->getTable('mailchimp_errors'),
        ...
        if (version_compare($context->getVersion(), '100.1.54') < 0) {
        ...
        if (version_compare($context->getVersion(), '100.1.58') < 0) {
            $connection->addColumn(
