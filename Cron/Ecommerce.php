                ...
                if (!count($batchArray['operations'])) {
                    ...
                    if (!isset($batchResponse['id'])) {
                        ...
                        */
                        ...
                        $syncBatches->setCartsNewCount($batchCounters[Data::QUO_NEW]);
                        $syncBatches->setOrdersNewCount($batchCounters[Data::ORD_NEW]);
                        $syncBatches->setSubscribersModifiedCount($batchCounters[Data::SUB_MOD]);
                        $syncBatches->setProductsModifiedCount($batchCounters[Data::PRO_MOD]);
